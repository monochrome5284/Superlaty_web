...
function CreateBrandProfile(){
    ...
    return(
        <div className="comtainer-fluid d-flex justify-content-center align-items-center position-relative bg-img-cover bg-image-animation-bottomToTop px-3 h-full-screen" style={{backgroundImage: "url(../images/logIn-background-img.jpg)"}}>
