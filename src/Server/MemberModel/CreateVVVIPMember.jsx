        ...
        <div className="container-fluid" style={{marginTop:"68px"}}>
            <div className="container py-4">
                <div className="d-flex flex-wrap align-items-center ps-3 mb-3">
                    ...
                    <h1 className="display-4 fw-bold">創建VVVIP會員 💎</h1>
                    <button type="button" className="btn btn-secondary m-3" data-bs-toggle="modal" data-bs-target="#upgradeLevelModal">
                        升級至SuperPRO
                    </button>
                </div>
                    ...
                    <div className="col-lg-6 form-lg-border p-lg-5 p-sm-3 p-1">
                        ...
                        <div className="mb-3">
                            ...
                            <div className="input-group mb-1">
                                ...
                                <input type="text" className="form-control" aria-label="Input Member Level Name"/>
                            </div>
                            <div className="input-group mb-1">
                        ...
                        <div className="row gx-3">
                            ...
                            <div className="col-6 mb-3">
                                <select className="form-select" defaultValue={"default"} id="payTime">
                            ...
                            <div className="col-6 mb-3">
                                <div className="input-group">
                                    <input type="number" className="form-control" id="intervalPrice"  placeholder="付費價格" aria-label="Enter the amount and use the drop-down buttons to select the currency type" defaultChecked/>
...
export default function CreateVVVIPMember() {
    return (
        <>
            <Header kind = "design"/>
            <Body />
