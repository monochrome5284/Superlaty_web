        ...
        <div className="container-fluid" style={{marginTop:"68px"}}>
            <div className="container py-4">
                <div className="d-flex flex-wrap align-items-center ps-3 mb-3">
                    ...
                    <h1 className="display-4 fw-bold me-3">創建付費會員 💎</h1>
                    <button type="button" className="btn btn-secondary fs-3" data-bs-toggle="modal" data-bs-target="#upgradeLevelModal">
                        升級至SuperPRO
                    </button>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="row d-flex flex-wrap flex-column justify-content-center align-items-center form-lg-border-none form-lg-max-height p-3 g-3">
                    ...
                    <div className="col-lg-6 d-flex justify-content-center align-items-center mb-3">
                        <div>
                            <label htmlFor="image-upload" className="ratio ratio-1x1">
                                <div className="profile-image" style={{backgroundImage: `url(${uploadedFileURL??base + "images/member_img3.jpg"})`}}>
                    ...
                    <div className="col-lg-6 order-lg-3 form-lg-border p-lg-5 p-sm-3 p-1">
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-select" id="linkedProject" defaultValue={"default"}>
                        ...
                        <div className="row gx-3">
                            <p className="form-label">會員付費機制＊</p>
                            <div className="col-6 mb-3">
                                <select className="form-select" id="payTime" defaultValue={"default"} >
                                    <option value={"default"} disabled >間隔時間</option>
                                    <option value="One-time">一次性付費</option>
                                    <option value="monthly">月訂閱</option>
                                    <option value="annual">年訂閱</option>
                                </select>
                            </div>
                            <div className="col-6 mb-3">
                                <div className="input-group">
                                    <input type="number" className="form-control" id="payAmount"  placeholder="付費價格" aria-label="Enter the amount and use the drop-down buttons to select the currency type" defaultChecked/>
                                    <button className="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">選擇幣種</button>
                                    <ul className="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <button onClick={handleClick} className="dropdown-item" >
                                                <img src={base + "images/tether-usdt-logo.svg"} alt="Option 3" className="me-2" width="24"/> USDT
                                            </button>
                                        </li>
                                        <li>
                                            <button onClick={handleClick} className="dropdown-item" >
                                                <img src={base + "images/ethereum-eth-logo.svg"} alt="Option 3" className="me-2" width="24"/> ETH
                                            </button>
                                        </li>
                                        <li>
                                            <button onClick={handleClick} className="dropdown-item" >
                                                <img src={base + "images/bitcoin-btc-logo.svg"} alt="Option 3" className="me-2" width="24"/> BTC
                                            </button>
                                        </li>
                                    </ul>
                                </div>
...
export default function CreatePaidMember() {
    return (
        <>
            <Header kind = "design"/>
            <Body/>
