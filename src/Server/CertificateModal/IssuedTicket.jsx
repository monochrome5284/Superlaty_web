        ...
        <div className="container-fluid"  style={{marginTop:"68px"}}>
            <div className="container py-4">
                <div className="d-flex flex-wrap align-items-center ps-3 mb-3">
                    ...
                    <h1 className="display-4 fw-bold">發行賦能票券</h1>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="row d-flex flex-wrap flex-column justify-content-center align-items-center form-lg-border-none form-lg-max-height p-3 g-3">
                    <h2 className="d-lg-none text-secondary text-center border-bottom pb-3">設定票券資料</h2>
                    ...
                    <div className="col-lg-6 form-lg-border p-lg-5 p-sm-3 p-1">
                        <h2 className="d-lg-block d-none text-secondary text-center border-bottom pb-3 mb-3">設定票券資料</h2>
                        <div className="row g-3">
                            <div className="col-6 mb-3">
                                <label htmlFor="ticketName" className="form-label">票券名稱＊</label>
                                <input type="text" className="form-control" id="ticketName" required/>
                            </div>
                            <div className="col-6 mb-3">
                                <label htmlFor="symbol" className="form-label">票券符號＊</label>
                        ...
                        <div className="mb-3 position-relative">
                            ...
                            <div className="input-group">
                                <input type="number" className="form-control" id="price" aria-label="Enter the amount and use the drop-down buttons to select the currency type"/>
                        ...
                        <div className="row gx-3">
                            <div className="col-6 mb-3">
                                ...
                                <input type="datetime-local" className="form-control" id="time" aria-label="input time"/>
                            </div>
                            <div className="col-6 mb-3">
                                <label className="form-label">活動地點</label>
                                <input type="text" className="form-control" id="location" defaultChecked/>
                            </div>
                        </div>
                        <div className="mb-3">
                            <p className="form-label">票券特性(未來均能改)</p>
...
export default function IssuedTicket() {
    return (
        <>
            <Header kind = "design"/>
            <Body/>
